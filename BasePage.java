...
public class BasePage {
    ...
    public WebDriver initialiseDriver(String browserName) {
        ...
        if (browserName.equals("Chrome")) {
            System.setProperty("webdriver.chrome.driver", "C:\\Users\\hetal\\IdeaProjects\\JavaLearning\\PomFramework4" +
    ...
    public Properties initialiseProperties() {
        ...
        try {//Location of file
            file= new FileInputStream("C:\\Users\\hetal\\IdeaProjects\\JavaLearning" +
                    "\\PomFramework4\\src\\test\\resources\\TestData\\config.properties");
